...
class AnimeScrapper:
  ...
  def myAnimelist(self):
    ...
    auth = HTTPBasicAuth("dbf858XXXXXXXXXdce932d4", "5e188df3d82064606XXXXXXXXXXXXXXXf67e9e76");
    p=1;
    ...
    while(True):
      ...
      if(soup.body.find('a', attrs={'data-ga-click-type' : 'review-more-reviews'})):
        print("foundddddddddddddddd more reviews")
        p+=1
      else:
        break
...
#p1.getLetterBoxDairy("Vignesh0306")
p1.myAnimelist()
#p1.redditScrapper()
